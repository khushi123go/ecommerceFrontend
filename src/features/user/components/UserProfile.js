    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                     ...
                     <h4 className='text-xl my-5 font-bold tracking-tight text-red-900'>email address : {userInfo.email}</h4>
                    {userInfo.role==='admin' && <h4 className='text-xl my-5 font-bold tracking-tight text-red-900'> role : {userInfo.role}</h4>}                         
                       </div>
                     ...
                     onClick={e=>{setShowAddAddressForm(true);setSelectedEditIndex(-1)}}
                      ...
                      { showAddAddressForm ? (
                           <form className='bg-white px-5 py-1 mt-12' 
                               noValidate
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-4">
            ...
            <div className="mt-2">
              <input
                id="email"
                {...register('email',{required:'email is requires'})}
                type="email"
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <input
                type="tel"
                {...register('phone',{required:'phone is requires'})}
                id="phone"
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"              />
            </div>
          </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <input
                type="text"
                {...register('street',{required:'street is requires'})}
                id="street"
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          ...
          <div className="sm:col-span-2 sm:col-start-1">
            ...
            <div className="mt-2">
              <input
                type="text"
                {...register('city',{required:'city is requires'})}
                id="city"
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
     ...
     onClick={e=>setShowAddAddressForm(false)}
        type="submit"
        className="rounded-md  px-3 py-2 text-sm font-semibold text-grey shadow-sm  shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      >
        Cancel
      </button>
      <button
