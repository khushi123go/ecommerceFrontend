      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* section of products and filters ends */}
           <Pagination filters={filters} page={page} setPage={setPage} handlePage={handlePage} totalItems={totalItems}></Pagination>
        </main>
      </div>
    </div>
            ...
            <div key={product.id} className="group relative border-solid border-2 border-gray-200 p-2">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <div>
                  ...
                  ₹{(Math.round(product.price*(1-product.discountPercentage/100)))*83}
                  </p>
